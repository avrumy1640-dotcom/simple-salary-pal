  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <Button onClick={downloadFilingPacket} className="rounded-full bg-foreground text-background hover:bg-foreground/90 gap-1.5">
...
function StatusBadge({ s }: { s: FilingRow["status"] }) {
  const map = {
    ...
    filed: { c: "bg-foreground text-background", t: "Ready", i: <CheckCircle2 className="h-3 w-3" /> },
  }[s];
