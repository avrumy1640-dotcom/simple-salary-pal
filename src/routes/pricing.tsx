...
function PricingPage() {
  return (
    <div className="page-in relative min-h-screen overflow-hidden text-foreground">
      ...
      <header className="sticky top-0 z-30 border-b border-primary/20 bg-white/80 backdrop-blur-2xl">
          ...
          {tiers.map((t, i) => (
            <div
              ...
              className={[
                ...
                t.highlight
                  ? "lg:scale-[1.04] lg:my-[-12px] bg-white border-2 border-primary/20 shadow-float hover:shadow-glow"
              ...
              <Link
                ...
                className={[
                  ...
                  t.highlight
                    ...
                    : "border border-white/20/15 bg-white text-foreground hover:bg-muted hover:shadow-soft",
                ].join(" ")}
              >
