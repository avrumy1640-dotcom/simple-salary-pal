      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <div className="flex gap-2">
          ...
          <Dialog open={open} onOpenChange={(v) => { setOpen(v); if (!v) setEditing(null); }}>
            <DialogTrigger asChild>
              <Button className="rounded-full gap-1.5 bg-foreground text-background hover:bg-foreground/90"><Plus className="h-4 w-4" /> Add contractor</Button>
            </DialogTrigger>
                  ...
                  return (
                    <tr key={c.id} className="border-t">
                      ...
                      <td className="px-3 py-3 font-medium">
                        {fmtUSD(ytd)}
                        {ytd >= 600 && <span className="ml-2 rounded-full bg-foreground px-2 py-0.5 text-[10px] font-semibold text-background">1099 required</span>}
                      </td>
