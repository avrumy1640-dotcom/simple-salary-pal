    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button onClick={downloadPacket} className="rounded-full bg-primary text-background hover:bg-foreground/90 gap-1.5">
        ...
        {(["reportable", "issues", "ready", "all"] as const).map((k) => (
          <button
            ...
            className={`rounded-full border px-3 py-1.5 text-xs font-medium capitalize transition-colors ${
              filter === k ? "bg-primary text-background border-foreground" : "bg-card hover:bg-accent"
            }`}
          >
