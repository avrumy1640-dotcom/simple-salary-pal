...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Run payroll in minutes. W-2 + 1099. Federal & state tax filing. Time tracking. Direct deposit. Built for US small business." },
      { property: "og:title", content: "Paylo — Payroll, HR & Tax Filing for Small Business" },
      ...
      <header className="sticky top-0 z-30 border-b border-border/40 bg-background/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-8">
          ...
          <nav className="hidden items-center gap-8 text-sm font-medium text-foreground/70 md:flex">
            ...
            <a className="hover:text-foreground" href="#features">Pricing</a>
            <a className="hover:text-foreground" href="#features">Why Paylo</a>
            <a className="hover:text-foreground" href="#features">Contact</a>
          </nav>
          <div className="flex items-center gap-2">
            <Link to="/auth" className="hidden sm:inline-flex">
              <button className="text-sm font-medium text-foreground/70 hover:text-foreground px-3 py-2">
                Sign in
              </button>
            </Link>
            <Link to="/auth">
        ...
        <div className="mx-auto max-w-6xl px-5 pt-16 pb-12 md:pt-28 md:pb-16">
          <motion.div {...fadeUp} className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-7 max-w-xl text-lg text-foreground/65 md:text-xl">
              ...
              all in one place. Built for the way small businesses actually work.
            </p>
            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <a href="#features">
                <Button size="lg" variant="ghost" className="rounded-full px-8 py-6 text-base">
                  See how it works
                </Button>
              </a>
            </div>
            <div className="mt-6 flex items-center justify-center gap-5 text-xs text-foreground/55">
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div className="text-[10px] uppercase tracking-wider text-foreground/70">Filed this quarter</div>
              </div>
            ...
            >
              <div className="flex items-center gap-2">
                <div className="grid h-7 w-7 place-items-center rounded-lg bg-foreground text-background"><Briefcase className="h-3.5 w-3.5" /></div>
                <div className="text-[10px] uppercase tracking-wider text-foreground/70">1099 contractors</div>
              </div>
              ...
              <div className="overflow-hidden rounded-[20px] border border-border/40 bg-secondary/30">
                <div className="flex items-center justify-between border-b border-border/40 bg-card px-4 py-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="ml-3 text-xs font-medium text-foreground/60">paylo.app/dashboard</div>
                  </div>
                </div>
                ...
                <div className="space-y-4 p-5 md:p-7">
                  ...
                  <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
                    <div className="rounded-2xl bg-card border border-border/50 p-4 shadow-sm">
                      ...
                      <div className="mt-2 text-xl font-bold">14</div>
                      <div className="text-[11px] text-foreground/60">Employees</div>
                    </div>
                    <div className="rounded-2xl bg-card border border-border/50 p-4 shadow-sm">
                      <Clock className="h-4 w-4 text-foreground/60" />
                      <div className="mt-2 text-xl font-bold">12<span className="text-sm text-foreground/50">/14</span></div>
                      <div className="text-[11px] text-foreground/60">Clocked in</div>
                    </div>
                    <div className="rounded-2xl bg-card border border-border/50 p-4 shadow-sm">
                      <Calendar className="h-4 w-4 text-foreground/60" />
                      <div className="mt-2 text-xl font-bold">3</div>
                      <div className="text-[11px] text-foreground/60">PTO requests</div>
                    </div>
                    <div className="rounded-2xl bg-foreground p-4 text-background shadow-sm">
                      <Wallet className="h-4 w-4 opacity-80" />
                      <div className="mt-2 text-xl font-bold">$48,210</div>
                      <div className="text-[11px] opacity-70">Next payroll</div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-2xl border border-border/50 bg-card p-5 shadow-sm">
                    ...
                    <div className="mt-2 flex gap-4 text-[11px] text-foreground/60">
                      <span>● Net pay</span>
                      <span>● Federal taxes</span>
                      <span>● State + FICA</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        >
          <div className="relative z-10">
            <h2 className="max-w-2xl text-4xl font-bold tracking-tight md:text-6xl">
              Pay your team in <span className="italic font-medium" style={{ fontFamily: "'Instrument Serif', serif" }}>minutes</span>, not days.
            </h2>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Link to="/auth">
                <Button size="lg" variant="ghost" className="rounded-full px-8 py-6 text-base text-background hover:bg-background/10">
                  Sign in
                </Button>
              </Link>
            </div>
